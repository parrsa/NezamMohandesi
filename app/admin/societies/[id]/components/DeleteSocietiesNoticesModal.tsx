...
interface DeleteSocietiesNoticesModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  isDeleting: boolean;
...
export default function DeleteSocietiesNoticesModal({
  isOpen,
  onClose,
  onConfirm,
  isDeleting,
  title = "حذف مصوبه",
  message = "آیا از حذف این مصوبه اطمینان دارید؟ این عمل قابل بازگشت نیست.",
}: DeleteSocietiesNoticesModalProps) {
