...
interface AddSocietiesModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: SocietiesFormData) => Promise<void>;
  isSubmitting: boolean;
}

const initialValues: SocietiesFormData = {
  title: "",
  description: "",
};

export default function AddSocietiesModal({
  isOpen,
  onClose,
  onSubmit,
  isSubmitting,
}: AddSocietiesModalProps) {
