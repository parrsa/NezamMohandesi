...
import { SocietiesFormData, societiesSchema } from "./societiesSchema";

interface EditSocietiesModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function EditSocietiesModal({
  isOpen,
  onClose,
  onSubmit,
  isSubmitting,
  data,
}: EditSocietiesModalProps) {
  const initialValues: SocietiesFormData = useMemo(() => {
    return {
      title: data?.title || "",
  ...
  return (
    ...
    >
      <Formik
        ...
        validationSchema={societiesSchema}
