...
interface DeleteSocietiesModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  isDeleting: boolean;
...
export default function DeleteSocietiesModal({
  isOpen,
  onClose,
  onConfirm,
  isDeleting,
  title = "حذف مجمع",
  message = "آیا از حذف این مجمع اطمینان دارید؟ این عمل قابل بازگشت نیست.",
}: DeleteSocietiesModalProps) {
