...
import AddContentModal from "../../[id]/[contentId]/components/AddContentModal";
import EditContentModal from "../../[id]/[contentId]/components/EditContentModal";

export default function CategoriesContentPage() {
  ...
  const { categoryContentId } = useParams();
