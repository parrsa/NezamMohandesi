...
export default function Ratifications() {
  return (
    <div className="grid grid-cols-3 gap-3 bg-white rounded-2xl p-3 mt-5">
      {approvalsListItem.map((item) => {
        return (
          <div key={item.id} className="flex flex-col gap-5">
            <h2 className="text-[#334155] font-bold pr-2 text-xl flex items-center gap-3">
              <BorderIcon />
              {item.name}
            </h2>
